...
$(".wbsZwischenTest .wbsZwischen_antwort_speichern").on("click", function() {

    // сначало нужно получить айди вопроса
    var frage_id = $(".wbsZwischenTest_frage_id").attr("data-frage-id");
    ...
    $.ajax({
    	...
    	url: "/views/wbsZwischen/wbsZwischenTestAjax.php",
  		method: "POST",
  		dataType:"text",
      ...
      success: function(data){
        ...
        var link = $(".wbsZwischen_antwort_speichern").attr("data-link");
