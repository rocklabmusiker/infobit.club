...
<body>
	...
	<div class="container-fluid anfrage">
		<h1>SIE WURDEN GESPERRT</h1>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-4">
				<div class="jumbotron jumbotron-fluid">
				  <div class="container">
				    <h3 class="display-2 text-center" style="font-size: 30px;">ZU VIELE FEHLVERSUCHE.</h3>
				    <p class="lead text-center">Hast du deine Zugangsdaten vergessen?</p>
