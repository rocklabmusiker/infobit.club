...
if(isset($_POST['cat_id'])) {
	...
	if($result = $db->prepare($sql)){
		...
		while($row = $result->fetch()){
			...
			$session_antworten = $_SESSION['session_user_fragen_wbs_zwischen'][$row['frage_id']]['user_antworten'];
			...
			$output .= '<div class="wbsZwischenTest_ergebnisse_content my-3 rounded" style="border: 2px solid ' .$antwort_richtig_border.' !important;">
