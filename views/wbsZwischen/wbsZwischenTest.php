...
<div 	class="container wbsZwischenTest"
			data-user-id="<?php echo $_SESSION['user_id']; ?>"
			data-cat-theme="<?php echo $_SESSION['cat_theme_wbs_zwischen']; ?>">
	...
	<?php if(isset($fragen_anzahl)): ?>
		...
		<?php if((int)$fragen_anzahl[0] - 1 >= $frage_num): ?> <!--fragen_anzahl beginnt mit 1 und frage_num mit 0-->
			...
			<div class="seller-trenner">
				...
				<div class="float-right wbsZwischenTest_timer" data-seconds=""></div>
			</div>

			<div class="row">
				<?php if(isset($frage)): ?>

					<?php $_SESSION['cat_theme_wbs_zwischen'] = $frage['frage_cat_theme']; ?>

						<div class="col-md-12 wbsZwischenTest_frage_id" data-frage-id="<?php echo $frage['frage_id']; ?>">
							<!--mehreren Anterten-->
			...
			<div class="row">
				<div class="col-md-2 mt-5 mb-5">
					<a 	href="/wbsZwischenTest/<?php echo $cat_id; ?>?cat_id=<?php echo $cat_id; ?>&frage_num=<?php if($_GET['frage_num'] == 0 ){ echo  0;} else{echo $_GET['frage_num'] - 1;} ?>"
						class="btn btn-danger btn-block">Zurück</a>
				</div>
				<div class="col-md-6 mt-5 mb-5">
					<button type="button"
									class="btn btn-dark btn-block wbsZwischen_antwort_speichern"
									data-link="/wbsZwischenTest/<?php echo $cat_id; ?>?cat_id=<?php echo $cat_id; ?>&frage_num=<?php echo $frage_num += 1;?>">
			...
			<?php else: ?><!--keine Fragen mehr -->
				...
				<div class="row wbsZwischenTest_ergebnis">
					<div class="col-md-12">
							<div class="jumbotron bg-dark">
							  <h1 class="display-3 text-center text-white wbsZwischenTest_titel">ERGEBNIS</h1>
							  <hr class="my-4">
								<div class="row">
										<div class="col-md-3">
											<div class="card wbsZwischenTest_card">
											...
											<div class="card wbsZwischenTest_card">
											  ...
											  <div class="card-body">
											  	<?php if(isset($gesamtprozentzahl)): ?>
											    	<p class="card-text display-3 text-center pt-0 mt-0 wbsZwischenTest_gesamtprozentzahl" style="margin-top:3px;" data-gesamtprozentzahl="<?php echo $gesamtprozentzahl; ?>">
										...
										<div class="col-md-3">
											<div class="card wbsZwischenTest_card">
											  ...
											  <div class="card-body">
											    <p 	class="card-text display-3 text-center pt-0 mt-0 wbsZwischenTest_vergangene_zeit"
															style="margin-top:3px;" data-vergangene-zeit="">
										...
										<div class="col-md-3">
											<div class="card wbsZwischenTest_card">
											  ...
											  <div class="card-body">
											    <p class="card-text display-3 text-center pt-0 mt-0 wbsZwischenTest_erreichte_note" data-erreichte-note="<?php echo $erreichte_note; ?>">
								...
								<hr class="my-4">
								<button class="btn btn-danger btn-lg wbsZwischenTest_ergebnisse_einsehen_button" data-cat-id="<?php echo $_GET['cat_id']; ?>">Ergebnisse ansehen und speichern</button>
								<a href="/wbsZwischen" class="btn btn-light btn-lg wbsZwischenTest_test_beenden" style="display: none;">Test beenden</a>
							</div>
					</div>
					<!--ajax content ergebnisse-->
					<div class="wbsZwischenTest_ergebnisse_einsehen_content px-3"></div>
				</div>
		<?php endif; ?>
...
<script src="/template/js/ajax/wbsZwischenTest.js"></script>
<script src="/template/js/ajax/wbsZwischenTestShowResult.js"></script>


<script>

var clock = $('.wbsZwischenTest_timer');
var timerStop = false;
var loopTimer = null;

		// Set a cookie
if(!$.cookie('timestamp_timer_wbs_zwischen')) {
		var date = new Date();
		var currentTimestamp = date.getTime();
		$.cookie('timestamp_timer_wbs_zwischen', currentTimestamp);
}

var startTime = parseInt($.cookie('timestamp_timer_wbs_zwischen'));

if ($.cookie('timestamp_timer_wbs_zwischen_pause')) {
		var usedTime = parseInt($.cookie('timestamp_timer_wbs_zwischen_pause'));
} else {
		usedTime  = 0;
}
...
function timerStart() {
		...
		loopTimer = setInterval(function() {
				...
				usedTime += 1;
				$.cookie('timestamp_timer_wbs_zwischen_pause', usedTime);
...
function getEndTime(){
	...
	$(".wbsZwischenTest_vergangene_zeit").text(time);
	$(".wbsZwischenTest .wbsZwischenTest_vergangene_zeit").attr("data-vergangene-zeit", time);

}

getEndTime();

$(".wbsZwischenTest_ergebnisse_einsehen_button").click(function(){
	timerStop = true;
	usedTime  = 0;
	$.cookie('timestamp_timer_wbs_zwischen_pause',usedTime);
});
